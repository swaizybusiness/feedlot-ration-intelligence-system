...
function QuickMode({ liveState, setLiveState, carcassState, setCarcassState, onProfessional }) {
  ...
  const scenarios = [52, 54, 56, 58].map((dp) => ({ dp, result: calculateQuickCarcass({ ...carcassState, dressingPct: dp }) }));
